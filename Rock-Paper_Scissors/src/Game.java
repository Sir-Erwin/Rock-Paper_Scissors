...
public class Game {
    ...
    public void scoreCal(Move c, Move u) {
        if (c.toString().equals("R") && u.toString().equals("S")) {
            compAdd();
        } else if (c.toString().equals("R") && u.toString().equals("P")) {
            uAdd();
        } else if (c.toString().equals("P") && u.toString().equals("S")) {
            uAdd();
        } else if (c.toString().equals("P") && u.toString().equals("R")) {
            compAdd();
        } else if (c.toString().equals("S") && u.toString().equals("P")) {
            compAdd();
        } else if (c.toString().equals("S") && u.toString().equals("R")) {
            uAdd();
        } else if (!u.toString().equals("R") || !u.toString().equals("P") || !u.toString().equals("S")) {
            moves++;
        }
    }
}
